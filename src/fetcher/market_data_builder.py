...
Builds and manages market data for stock universes.
...
class MarketDataBuilder:
    """
    Market data builder for stock price databases

    Builds comprehensive market data including:
    - End-of-day price data for individual symbols
    ...
    def fetch_complete_universe_history(
        ...
        Example:
            ...
            builder = MarketDataBuilder(api_key=api_key)
